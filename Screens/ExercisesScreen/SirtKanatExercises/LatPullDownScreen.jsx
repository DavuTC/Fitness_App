...
function LatPullDownScreen({ navigation }) {
    return (
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
        <Image
        source={require('../../../Images/SirtKanat/LatPullDown.jpg')} // Resmin dosya yolunu projenize göre ayarlayın
...
export default LatPullDownScreen;
