...
function HangingLegRaiseScreen({ navigation }) {
    return (
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
        
        <Image
        source={require('../../../Images/Karin/HangingLegRaise.jpg')} // Resmin dosya yolunu projenize göre ayarlayın
        style={{ width: 300, height: 300 }} // Genişlik ve yüksekliği ihtiyaca göre ayarlayın
      />
        </View>
        <Text>Hanging Leg Raise</Text>
...
export default HangingLegRaiseScreen;
