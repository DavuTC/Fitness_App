...
function OverheadPressScreen({ navigation }) {
    return (
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
        
        <Image
        source={require('../../../Images/Omuz/OverheadPress.jpg')} // Resmin dosya yolunu projenize göre ayarlayın
...
export default OverheadPressScreen;
