...
function ArnoldPressScreen({ navigation }) {
    return (
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
        
        <Image
        source={require('../../../Images/Omuz/ArnoldPress.jpg')} // Resmin dosya yolunu projenize göre ayarlayın
        style={{ width: 300, height: 200 }} // Genişlik ve yüksekliği ihtiyaca göre ayarlayın
      />
        </View>
        <Text>Arnold Press</Text>
...
export default ArnoldPressScreen;
