...
function CableBentOverLateralRaiseScreen({ navigation }) {
    return (
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
        
        <Image
        source={require('../../../Images/Omuz/CableBentOverLateralRaise.jpg')} // Resmin dosya yolunu projenize göre ayarlayın
        style={{ width: 300, height: 200 }} // Genişlik ve yüksekliği ihtiyaca göre ayarlayın
      />
        </View>
        <Text>Cable Bent Over Lateral Raise</Text>
...
export default CableBentOverLateralRaiseScreen;
