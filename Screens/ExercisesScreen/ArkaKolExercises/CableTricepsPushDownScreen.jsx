...
function CableTricepsPushDownScreen({ navigation }) {
    return (
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
        
        <Image
        source={require('../../../Images/Arkakol/CableTricepsPushDown.png')} // Resmin dosya yolunu projenize göre ayarlayın
        style={{ width: 300, height: 200 }} // Genişlik ve yüksekliği ihtiyaca göre ayarlayın
      />
        </View>
        <Text>Cable Triceps Push Down</Text>
...
export default CableTricepsPushDownScreen;
