...
function DiamondPushUpScreen({ navigation }) {
    return (
      <View style={styles.container}>
        <View style={styles.buttonContainer}>
        <Image
        source={require('../../../Images/Arkakol/DiamondPushUp.png')} // Resmin dosya yolunu projenize göre ayarlayın
...
export default DiamondPushUpScreen;
