...
function KarinScreen({ navigation }) {
  return (
    <View style= {StyleSheet.Container}>
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('Hanging Leg Raise')}
      >
        <Text style={styles.buttonText}>Hanging Leg Raise</Text>
      </TouchableOpacity> 
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('Side Plank')}
      >
      ...
      <TouchableOpacity
        style={styles.button}
        onPress={() => navigation.navigate('Weighed Crunch')}
      >
        <Text style={styles.buttonText}>Weighed Crunch</Text>
      </TouchableOpacity>
